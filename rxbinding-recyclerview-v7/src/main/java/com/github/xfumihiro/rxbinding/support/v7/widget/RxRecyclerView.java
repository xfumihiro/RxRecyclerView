...
public final class RxRecyclerView {
  ...
  /**
   * Create an observable of the position of item click events for {@code recyclerView}.
   * <p>
   * <em>Warning:</em> The created observable keeps a strong reference to {@code recyclerView}.
   * Unsubscribe to free this reference.
   */
  @CheckResult @NonNull public static Observable<RecyclerViewItemClickEvent> RxRecyclerViewItemClickEvents(
      @NonNull RecyclerView recyclerView) {
    return Observable.create(new RecyclerViewItemClickEventOnSubscribe(recyclerView));
  }
